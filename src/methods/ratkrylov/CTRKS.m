function [ V, KR, Lrot, LR ] = CTRKS( A, B, funpos, funneg, V, KR, Lrot, LR, Xi,T)
...
%   are manipulated such that they all appear at the L side.
%
%   INPUT
...
function [V,Lrot,KR,LR,T] = ChaseKrotUp(V,Lrot,KR,LR,Krot,curr_i,T)
    ...
    for i=curr_i:-1:2
       ...
       %T(i:i+1,:) = CreateRotMat(RotH(Krot)) * T(i:i+1,:); % This is not
       %valid in complex arithmetic
